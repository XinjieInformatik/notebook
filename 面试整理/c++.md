...
* [C++ 常考面试题总结](#c-)
        ...
        * [C++ 内存管理](#c-)
        * [指针和引用的区别](#)
        * [C++ 中 struct 和 class](#c--struct--class)
        * [智能指针](#)
        * [重载运算符和重载函数](#)
        * [new/delete与malloc/free的区别](#newdeletemallocfree)
        * [delete 和 delete[] 的区别](#delete--delete-)
        * [构造函数,析构函数](#)
        * [define 和 const 的联系与区别](#define--const-)
        * [ｃ++虚函数](#)
        * [纯虚函数](#)
        * [sizeof 与 strlen](#sizeof--strlen)
        * [内存对齐](#)
        * [C++源文件从文本到可执行文件经历的过程](#c)
        * [引用作为函数参数和返回值的好处](#)
        * [函数指针和指针函数](#)
        * [数组指针和指针数组](#)
        * [内联函数](#)
    ...
    * [面向对象](#)
        ...
        * [顶层 const 与底层 const](#-const--const)
        * [顺序容器](#)
            * [两种include方式](#include)
            * [vector 扩容](#vector-)
            * [deque](#deque)
